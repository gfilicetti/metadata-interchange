...
"""
Module Documentation for GCPSampleAssetManager here.
"""
...
class GCPSampleAssetManagerPlugin(PythonPluginSystemManagerPlugin):
    """
    ...
    @classmethod
    def interface(cls):
        from .GCPSampleAssetManagerInterface import GCPSampleAssetManagerInterface
        ...
        return GCPSampleAssetManagerInterface()
...
plugin = GCPSampleAssetManagerPlugin
