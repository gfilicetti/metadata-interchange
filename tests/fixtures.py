...
"""
Manager test harness test case fixtures for GCP Sample Asset Manager.
"""
from openassetio import constants
from openassetio_mediacreation.traits.content import LocatableContentTrait


IDENTIFIER = "google.manager.gcpsample_asset_manager"

VALID_REF = "gcpsample_asset_manager:///AssetIdentifier"
NON_REF = "not a Ŕeference"
MALFORMED_REF = "gcpsample_asset_manager:///AssetIdentifier?unsupportedQueryParam"
EXISTING_REF = "gcpsample_asset_manager:///anAsset"
...
fixtures = {
    ...
    "Test_displayName": {"test_matches_fixture": {"display_name": "GCP Sample Asset Manager"}},
    "Test_info": {
        "test_matches_fixture": {
            "info": {constants.kInfoKey_EntityReferencesMatchPrefix: "gcpsample_asset_manager:///"}
        }
    },
    "Test_resolve": {
        "shared": {
            ...
            "a_reference_to_a_missing_entity": "gcpsample_asset_manager:///missing_entity",
            "the_error_string_for_a_reference_to_a_missing_entity": (
                "Entity 'gcpsample_asset_manager:///missing_entity' not found"
            ),
