...
GCPSampleAssetManager behaves with the correct business logic.
"""
...
class Test_resolve(FixtureAugmentedTestCase):
    """
    Test suite for the business logic of GCPSampleAssetManager
    ...
    __test_entity = (
        "gcpsample_asset_manager:///anAsset",
        {
