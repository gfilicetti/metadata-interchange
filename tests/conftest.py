...
"""
Shared fixtures for GCPSampleAssetManager pytest coverage.
"""
...
def harness_fixtures(base_dir):
    """
    Provides the fixtues dict for GCPSampleAssetManager when used with
...
def base_dir():
    """
    Provides the path to the base directory for the GCPSampleAssetManager
    codebase.
    """
